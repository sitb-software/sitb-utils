...
public class RSA {
     ...
     * @param file 要加密的文件
     */
    public static void encrypt(RSAPublicKeySpec key, File file) throws IOException {
        // 用来保存加密结果的临时list
        ArrayList<BigInteger> list = new ArrayList<>();
     ...
     * @param toFile 加密后的文件
     */
    public static void encryptToFile(RSAPublicKeySpec key, File file, File toFile) throws IOException {
        // 用来保存加密结果的临时list
        ArrayList<BigInteger> list = new ArrayList<>();
        readEncrypt(list, key, file);
    ...
    public static char decrypt(RSAPrivateKeySpec key, BigInteger cipher) {
        // 解密过程
        BigInteger src = cipher.modPow(key.getPrivateExponent(), key.getModulus());
        // 转换成char
     ...
     * @param file 文件名
     */
    public static void decrypt(RSAPrivateKeySpec key, File file) throws IOException {
     ...
     * @param file 解密的文件
     */
    public static void decryptToFile(RSAPrivateKeySpec key, File file, File toFile) throws IOException {
        List<BigInteger> list = new ArrayList<>();
        readDecrypt(list, file);
     ...
     * @param file 文件
     */
    private static void readEncrypt(List<BigInteger> list, RSAPublicKeySpec key, File file) throws IOException {
        // 用来读取文件内容
     ...
     * @param file 文件
     */
    private static void writeDecrypt(RSAPrivateKeySpec key, List<BigInteger> list, File file) throws IOException {
        // 获取要写入的文件，并构造一个BufferedWriter对象
        BufferedWriter writer = new BufferedWriter(new FileWriter(file));
        for (BigInteger i : list) {
